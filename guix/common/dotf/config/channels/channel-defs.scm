...
channel doesn't get rebuild everytime `guix pull ...` is executed."
  (let* [(channel-name 'guix-ai-cloud)]
    ...
    (channel
     ...
     (introduction
      (make-channel-introduction
       ;; Danny's 1st commit and gpg fingerprint
       ...
       ;; First authenticated commit of Bost's fork. This commit authorizes
       ;; Rostislav Svoboda's key. Requires:
       ;;     guix git authenticate \
       ;;       0051f7605d10c563c2092a26c4a45e4320d2a04f \
       ;;       "A2FE D89D 9A10 000E 5BF6 3B37 612D 3636 8877 DC81" \
       ;;       --keyring=upstream/keyring --stats
       "0051f7605d10c563c2092a26c4a45e4320d2a04f"
       ;; 🐠 git log -1 --format=%B 0051f7605d10c563c2092a26c4a45e4320d2a04f
       ;; Authorize Rostislav Svoboda's key
