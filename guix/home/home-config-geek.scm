...
guix home --allow-downgrades -L $dxh reconfigure $dxh/home-config-geek.scm
# -L --load-path
...
(define scheme-files-service
  ((compose
    ...
    (hu:partial
     append
     (cond
      [(or (hu:home-ecke-config) (hu:home-geek-config))
       (list
...
;; TODO put home-config-geek and system-configuration in one file
