...
#!/usr/bin/env -S guile \\
-L ./guix/common -L ./guix/home/common -e (scm-bin\ er) -s
!#

cd $dotf
./guix/home/common/scm-bin/er.scm --gx-dry-run
./guix/home/common/scm-bin/er.scm
      ...
      (begin
        (apply
         (partial set-config-editable
                  #:gx-dry-run val-gx-dry-run #:profile crafted)
         val-rest-args)))))
