(define-module (scm-bin pkill-crafted)
...
#!/usr/bin/env -S guile \\
-L ./guix/common -L ./guix/home/common -e (scm-bin\ pkill-crafted) -s
!#

cd $dotf
./guix/home/common/scm-bin/pkill-crafted.scm --gx-dry-run
./guix/home/common/scm-bin/pkill-crafted.scm
