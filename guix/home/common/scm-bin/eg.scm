...
#!/usr/bin/env -S guile \\
-L ./guix/common -L ./guix/home/common -e (scm-bin\ eg) -s
!#

cd $dotf
./guix/home/common/scm-bin/eg.scm --gx-dry-run
./guix/home/common/scm-bin/eg.scm
      ...
      (begin
        (apply
         (partial set-config-editable
                  #:gx-dry-run val-gx-dry-run #:profile spguimacs)
         val-rest-args)))))
