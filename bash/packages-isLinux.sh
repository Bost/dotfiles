...
gpac						install
gpac-modules-base:amd64				install
gparted						install
gpgv						install
graphviz					install
grep						install
...
libaudio-flac-header-perl			install
libaudio-musepack-perl				install
libaudio-scan-perl				install
libaudio-wma-perl				install
...
libmp3-tag-perl					install
libmp3lame0:amd64				install
libmp4-info-perl				install
...
libofa0						install
libogg-vorbis-header-pureperl-perl		install
...
linux-headers-3.13.0-27				install
linux-headers-3.13.0-27-generic			install
linux-headers-3.13.0-29				install
linux-headers-3.13.0-29-generic			install
...
linux-headers-3.13.0-34				install
linux-headers-3.13.0-34-generic			install
