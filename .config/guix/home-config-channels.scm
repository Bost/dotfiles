...
(define (home-config-channels)
  "Channels needed for the home configuration"
  (list
...
;; TODO DRY syst-config-channels in the .config/guix/syst-config-channels.scm
(define (syst-config-channels)
  "Channels needed for the system configuration"
  (cons*
